...
This v1.4 has a revision in some resistor values and a decreased PCB size - the width is just under 100mm. Please note that I have not tested the gerbers yet, so please report any errors.
